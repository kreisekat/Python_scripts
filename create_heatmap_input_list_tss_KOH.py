...
create_heatmap_input_list_tss_KOH.py is free software: you can redistribute it
...
class CreateFisherFile(object):
    ...
    def _generate_output_filename(self):
        ...
        for KOH in glob.glob(self.filepath+all_KOH):
            ...
            filename.append('_'.join(filename_pattern)+"_heatmap_KOH_out4-10000-500-40-tss.txt")
    ...
    def _write_dataframe_to_disk(self):
        self.df.to_csv(self.filepath+"tss_heatmap_KOH_input.csv", index=False, header=False, sep=" ")
