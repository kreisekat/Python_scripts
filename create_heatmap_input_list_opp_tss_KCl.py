...
create_heatmap_input_list_opp_tss_KCl.py is free software: you can redistribute it
...
class CreateFisherFile(object):
    ...
    def _generate_output_filename(self):
        ...
        for KCl in glob.glob(self.filepath+all_KCl):
            ...
            filename.append('_'.join(filename_pattern)+"_heatmap_KCl_out4-10000-500-40-opp_tss.txt")
    ...
    def _write_dataframe_to_disk(self):
        self.df.to_csv(self.filepath+"opp_tss_heatmap_KCl_input.csv", index=False, header=False, sep=" ")
